      ...
      <div className="flex flex-col md:flex-row items-start space-y-8 md:space-y-0 md:space-x-8">
        ...
        <div className="w-full md:w-2/3 space-y-4">
          ...
          <p>
            ...
            When the pandemic hit hard in 2020, he started to make beats and collaborate with other artists and that created a new chapter for him. 
            After years of being a sideman, absorbing nutritions from different genres, he is now stepping out to share his music to the world.
          </p>
          <p>
